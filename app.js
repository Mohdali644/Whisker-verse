...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function showResults() {
        ...
        else if(score > 2) message = "Great job! Your cat knowledge is strong. ⚡";
        else message = "Time to study the Knowledge Vault! 📚";
    ...
    if (factText) factObserver.observe(factText, { childList: true, characterData: true, subtree: true });
...
// --- FEATURE B: THE ULTIMATE BEAST AI MOUSE (PREMIUM INTERNET ICON) ---
    ...
    if (thereminPad) {
        ...
        const stopTheremin = () => {
            ...
            if (gainNode) gainNode.gain.setTargetAtTime(0, audioCtx.currentTime, 0.1); // Fade out
        };
